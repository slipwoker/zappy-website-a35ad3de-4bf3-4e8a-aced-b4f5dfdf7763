  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      const label = field.closest('[class*="field"], [class*="group"], label, div')
        ?.querySelector('label')?.textContent?.trim() || field.placeholder || field.name || 'This field';

      const messages = {
        required: label + ' is required.',
        email: 'Please enter a valid email address.',
        minLength: 'Please enter at least ' + (field.dataset.minLength || '10') + ' characters.',
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a35ad3de-4bf3-4e8a-aced-b4f5dfdf7763',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a35ad3de-4bf3-4e8a-aced-b4f5dfdf7763';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a35ad3de-4bf3-4e8a-aced-b4f5dfdf7763';
